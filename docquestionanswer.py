...
CHECKPOINTS = {
    "Model1": "impira/layoutlm-document-qa",
    "Model1 for Invoices 💸": "binhnase04854/donut-invoice-docvqa",
    "Model2": "naver-clova-ix/donut-base-finetuned-docvqa",
}
...
with gr.Blocks(css=CSS) as demo:
    gr.Markdown("# QAS: Question Answering System by AEAINTELLIGENCE")
    gr.Markdown(
        "Question Answering System from PDFs,Images (created by [AEAINTELLIGENCE](https://www.aeaintelligence.com))"
    )
